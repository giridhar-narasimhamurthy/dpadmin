...
class DpadminAction(Action):
    ...
    """
    command: Literal["SET_REDUNDANCY", "SET_POLICY", "SET_LEVEL", "EXECUTE_RECOVERY", "SET_TOPOLOGY", "SET_RETENTION"] = Field(
        ..., 
        description="The specific data protection command to execute."
    )
    target: str = Field(
        ..., 
